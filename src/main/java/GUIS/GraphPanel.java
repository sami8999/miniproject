...
public class GraphPanel extends JPanel {
    ...
    public GraphPanel(Investment investment) {
        ...
        chart = ChartFactory.createCandlestickChart(investment.getTicker(), "Time", "Price",
    ...
    public DefaultHighLowDataset getGraphData(Investment investment, int daysBack){
        ...
        List<HistoricalQuote> history= investment.getHistory();

        int size = investment.getHistory().size();
